package foo.bar.foreapollo3.feature.authentication
...
import foo.bar.foreapollo3.LoginMutation
...
class Authenticator(
    ...
    private fun handleFailure(
        ...
        logger.i("handleFailure() $failureMessage t:${Thread.currentThread().id}")
